...
public class ObjectFactory {
    ...
    private final static QName _GetEmployeeById_QNAME = new QName("http://services/", "getEmployeeById");
    private final static QName _GetEmployeeByIdResponse_QNAME = new QName("http://services/", "getEmployeeByIdResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services/", name = "getEmployeeById")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services/", name = "getEmployeeByIdResponse")
